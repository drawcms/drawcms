---
title: "Documentation"
description: "Documentation, guides, and blog for DrawCMS — the open-source editor for animated technical diagrams."
template: splash
hero:
...
- [Blog](../blog/) — release notes, tutorials, and project news
...
DrawCMS is open-source software licensed under [GNU AGPL v3.0 only](https://github.com/dimasna/drawcms/blob/main/LICENSE). Read [ADR 001](decisions/001-licensing-and-repository-boundary.md) for the OSS and Cloud boundary, or visit the [source repository](https://github.com/dimasna/drawcms) to contribute.
