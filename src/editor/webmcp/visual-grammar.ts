...
> = {
  ...
  planning: {
    purpose: "A topic, organization role, or timeline annotation.",
    mostlyUsedFor: ["mind maps", "organization charts", "timelines"],
    avoidFor: ["formal UML or data-flow notation"],
    diagramTypes: ["general"],
    suitableMotionPresets: [],
    motionGuidance: "Keep planning diagrams static unless explaining a change over time.",
  },
  activity: {
    purpose: "An initial, final, history, or synchronization symbol.",
    mostlyUsedFor: ["state machines", "parallel activities", "fork and join"],
    avoidFor: ["services", "data stores"],
    diagramTypes: ["uml", "lifecycle", "flowchart"],
    suitableMotionPresets: [],
    motionGuidance: "Keep control symbols static; animate the transitions between them.",
  },
  deployment: {
    purpose: "A nesting boundary for a deployment host or system scope.",
    mostlyUsedFor: ["deployment diagrams", "use-case system boundaries"],
    avoidFor: ["individual actions"],
    diagramTypes: ["architecture", "uml", "use-case"],
    suitableMotionPresets: [],
    motionGuidance: "Keep boundaries static while highlighting their contents.",
  },
  network: {
    purpose: "A router, switch, or server in a network topology.",
    mostlyUsedFor: ["network topology", "infrastructure"],
    avoidFor: ["workflow decisions"],
    diagramTypes: ["architecture"],
    suitableMotionPresets: ["Pulse Node"],
    motionGuidance: "Highlight only the device currently processing network traffic.",
  },
  dfd: {
    purpose: "A conventional data-flow entity, process, or open data store.",
    mostlyUsedFor: ["data-flow diagrams", "data transformations"],
    avoidFor: ["control-flow decisions", "sequence lifelines"],
    diagramTypes: ["data-flow"],
    suitableMotionPresets: ["Pulse Node"],
    motionGuidance: "Highlight active processes and animate the labeled data flows.",
  },
  sequence: {
